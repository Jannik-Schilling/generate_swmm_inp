...
<qgis simplifyDrawingHints="0" minScale="0" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyAlgorithm="0" readOnly="0" maxScale="0" symbologyReferenceScale="-1" version="3.30.3-'s-Hertogenbosch" simplifyLocal="1">
  ...
  <elevation symbology="Line" showMarkerSymbolInSurfacePlots="0" extrusion="0" binding="Centroid" zoffset="0" respectLayerSymbol="1" extrusionEnabled="0" zscale="1" clamping="Terrain" type="IndividualFeatures">
    ...
    <profileLineSymbol>
      <symbol frame_rate="10" alpha="1" is_animated="0" force_rhr="0" clip_to_extent="1" type="line" name="">
        ...
        <layer pass="0" locked="0" id="{8c9d0ecc-8a27-4c48-9540-4801b9014c94}" enabled="1" class="SimpleLine">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol frame_rate="10" alpha="1" is_animated="0" force_rhr="0" clip_to_extent="1" type="fill" name="">
        ...
        <layer pass="0" locked="0" id="{2c49af0c-c7c6-4cb0-a464-aef393f01467}" enabled="1" class="SimpleFill">
          <Option type="Map">
            ...
            <Option value="3x:0,0,0,0,0,0" type="QString" name="offset_map_unit_scale"/>
            <Option value="MM" type="QString" name="offset_unit"/>
            <Option value="174,119,127,255" type="QString" name="outline_color"/>
    ...
    <profileMarkerSymbol>
      <symbol frame_rate="10" alpha="1" is_animated="0" force_rhr="0" clip_to_extent="1" type="marker" name="">
        ...
        <layer pass="0" locked="0" id="{ec18cc4e-4b0a-406e-8a00-f58d8647632a}" enabled="1" class="SimpleMarker">
          <Option type="Map">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" enableorderby="0" type="singleSymbol" referencescale="-1">
    <symbols>
      <symbol frame_rate="10" alpha="1" is_animated="0" force_rhr="0" clip_to_extent="1" type="marker" name="0">
        ...
        <layer pass="0" locked="0" id="{5083b5d5-cefc-4560-8ea1-b6818690e1b2}" enabled="1" class="SimpleMarker">
          <Option type="Map">
    ...
    <DiagramCategory penColor="#000000" lineSizeScale="3x:0,0,0,0,0,0" barWidth="5" showAxis="1" sizeScale="3x:0,0,0,0,0,0" opacity="1" scaleDependency="Area" maxScaleDenominator="0" spacingUnit="MM" lineSizeType="MM" labelPlacementMethod="XHeight" penWidth="0" backgroundAlpha="255" width="15" rotationOffset="270" spacingUnitScale="3x:0,0,0,0,0,0" direction="0" enabled="0" minScaleDenominator="0" penAlpha="255" backgroundColor="#ffffff" spacing="5" height="15" scaleBasedVisibility="0" sizeType="MM" diagramOrientation="Up" minimumSize="0">
      ...
      <axisSymbol>
        <symbol frame_rate="10" alpha="1" is_animated="0" force_rhr="0" clip_to_extent="1" type="line" name="">
          ...
          <layer pass="0" locked="0" id="{9b85d5a7-5162-47f1-b2c5-8c9ca179e419}" enabled="1" class="SimpleLine">
            <Option type="Map">
              <Option value="0" type="QString" name="align_dash_pattern"/>
              <Option value="square" type="QString" name="capstyle"/>
              <Option value="5;2" type="QString" name="customdash"/>
  ...
  <aliases>
    ...
    <alias index="4" field="FixedStage" name=""/>
    <alias index="5" field="Curve_TS" name=""/>
    <alias index="6" field="FlapGate" name=""/>
    <alias index="7" field="RouteTo" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="FixedStage" expression=""/>
    <default applyOnUpdate="0" field="Curve_TS" expression=""/>
    <default applyOnUpdate="0" field="FlapGate" expression=""/>
    <default applyOnUpdate="0" field="RouteTo" expression=""/>
  ...
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" field="FixedStage" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="Curve_TS" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="FlapGate" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="RouteTo" unique_strength="0" notnull_strength="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" columnCount="1" collapsedExpression="" showLabel="1" groupBox="0" collapsed="0" visibilityExpressionEnabled="0" visibilityExpression="" name="General">
      ...
      <attributeEditorContainer collapsedExpressionEnabled="0" columnCount="1" collapsedExpression="" showLabel="0" groupBox="1" collapsed="0" visibilityExpressionEnabled="1" visibilityExpression=" &quot;Type&quot; in ('TIDAL','TIMESERIES')" name="Tidal or Timeseries">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
        </labelStyle>
      ...
      <attributeEditorContainer collapsedExpressionEnabled="0" columnCount="1" collapsedExpression="" showLabel="0" groupBox="1" collapsed="0" visibilityExpressionEnabled="1" visibilityExpression=" &quot;Type&quot; = 'FIXED'" name="Fixed">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
        </labelStyle>
