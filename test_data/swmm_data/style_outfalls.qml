...
<qgis symbologyReferenceScale="-1" simplifyAlgorithm="0" simplifyLocal="1" readOnly="0" simplifyDrawingTol="1" version="3.32.0-Lima" maxScale="0" minScale="0" labelsEnabled="0" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" simplifyDrawingHints="0">
  ...
  <elevation extrusionEnabled="0" extrusion="0" type="IndividualFeatures" zscale="1" respectLayerSymbol="1" symbology="Line" binding="Centroid" showMarkerSymbolInSurfacePlots="0" zoffset="0" clamping="Terrain">
    ...
    <profileLineSymbol>
      <symbol clip_to_extent="1" alpha="1" type="line" force_rhr="0" is_animated="0" name="" frame_rate="10">
        ...
        <layer pass="0" locked="0" enabled="1" id="{8c9d0ecc-8a27-4c48-9540-4801b9014c94}" class="SimpleLine">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol clip_to_extent="1" alpha="1" type="fill" force_rhr="0" is_animated="0" name="" frame_rate="10">
        ...
        <layer pass="0" locked="0" enabled="1" id="{2c49af0c-c7c6-4cb0-a464-aef393f01467}" class="SimpleFill">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol clip_to_extent="1" alpha="1" type="marker" force_rhr="0" is_animated="0" name="" frame_rate="10">
        ...
        <layer pass="0" locked="0" enabled="1" id="{ec18cc4e-4b0a-406e-8a00-f58d8647632a}" class="SimpleMarker">
          <Option type="Map">
  ...
  <renderer-v2 enableorderby="0" type="singleSymbol" symbollevels="0" referencescale="-1" forceraster="0">
    <symbols>
      <symbol clip_to_extent="1" alpha="1" type="marker" force_rhr="0" is_animated="0" name="0" frame_rate="10">
        ...
        <layer pass="0" locked="0" enabled="1" id="{5083b5d5-cefc-4560-8ea1-b6818690e1b2}" class="SimpleMarker">
          <Option type="Map">
            ...
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                <Option type="Map" name="offset">
                  ...
                  <Option type="QString" value="'0'|| ',' || tostring(0.166667*(if( @map_scale> 6000 ,max(4*6000/@map_scale,2),4)))" name="expression"/>
                  <Option type="int" value="3" name="type"/>
                </Option>
                <Option type="Map" name="size">
                  <Option type="bool" value="true" name="active"/>
                  <Option type="QString" value="if( @map_scale> 6000 ,max(4*6000/@map_scale,2),4)" name="expression"/>
                  <Option type="int" value="3" name="type"/>
                </Option>
              </Option>
              <Option type="QString" value="collection" name="type"/>
    ...
    <DiagramCategory spacing="5" spacingUnitScale="3x:0,0,0,0,0,0" labelPlacementMethod="XHeight" penAlpha="255" minScaleDenominator="0" height="15" scaleBasedVisibility="0" diagramOrientation="Up" spacingUnit="MM" sizeType="MM" minimumSize="0" enabled="0" showAxis="1" barWidth="5" opacity="1" penWidth="0" lineSizeType="MM" direction="0" lineSizeScale="3x:0,0,0,0,0,0" scaleDependency="Area" sizeScale="3x:0,0,0,0,0,0" penColor="#000000" backgroundColor="#ffffff" backgroundAlpha="255" rotationOffset="270" width="15" maxScaleDenominator="0">
      ...
      <axisSymbol>
        <symbol clip_to_extent="1" alpha="1" type="line" force_rhr="0" is_animated="0" name="" frame_rate="10">
          ...
          <layer pass="0" locked="0" enabled="1" id="{9b85d5a7-5162-47f1-b2c5-8c9ca179e419}" class="SimpleLine">
            <Option type="Map">
              <Option type="QString" value="0" name="align_dash_pattern"/>
              <Option type="QString" value="square" name="capstyle"/>
              <Option type="QString" value="5;2" name="customdash"/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" expression="" field="FixedStage"/>
    <default applyOnUpdate="0" expression="" field="Curve_TS"/>
    <default applyOnUpdate="0" expression="" field="FlapGate"/>
    <default applyOnUpdate="0" expression="" field="RouteTo"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" notnull_strength="0" constraints="0" field="FixedStage" unique_strength="0"/>
    <constraint exp_strength="0" notnull_strength="0" constraints="0" field="Curve_TS" unique_strength="0"/>
    <constraint exp_strength="0" notnull_strength="0" constraints="0" field="FlapGate" unique_strength="0"/>
    <constraint exp_strength="0" notnull_strength="0" constraints="0" field="RouteTo" unique_strength="0"/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column width="-1" type="field" name="FixedStage" hidden="0"/>
      <column width="-1" type="field" name="Curve_TS" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer groupBox="0" verticalStretch="0" collapsedExpressionEnabled="0" type="Tab" horizontalStretch="0" collapsed="0" collapsedExpression="" visibilityExpressionEnabled="0" visibilityExpression="" name="General" columnCount="1" showLabel="1">
      ...
      <attributeEditorField verticalStretch="0" horizontalStretch="0" name="FlapGate" showLabel="1" index="6">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" style="" underline="0" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField verticalStretch="0" horizontalStretch="0" name="RouteTo" showLabel="1" index="7">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" style="" underline="0" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField verticalStretch="0" horizontalStretch="0" name="Type" showLabel="1" index="3">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" style="" underline="0" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorContainer groupBox="1" verticalStretch="0" collapsedExpressionEnabled="0" type="GroupBox" horizontalStretch="0" collapsed="0" collapsedExpression="" visibilityExpressionEnabled="1" visibilityExpression=" &quot;Type&quot; in ('TIDAL','TIMESERIES')" name="Tidal or Timeseries" columnCount="1" showLabel="0">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" style="" underline="0" strikethrough="0" bold="0"/>
        </labelStyle>
        <attributeEditorField verticalStretch="0" horizontalStretch="0" name="Curve_TS" showLabel="1" index="5">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" style="" underline="0" strikethrough="0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
      </attributeEditorContainer>
      <attributeEditorContainer groupBox="1" verticalStretch="0" collapsedExpressionEnabled="0" type="GroupBox" horizontalStretch="0" collapsed="0" collapsedExpression="" visibilityExpressionEnabled="1" visibilityExpression=" &quot;Type&quot; = 'FIXED'" name="Fixed" columnCount="1" showLabel="0">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" style="" underline="0" strikethrough="0" bold="0"/>
        </labelStyle>
        <attributeEditorField verticalStretch="0" horizontalStretch="0" name="FixedStage" showLabel="1" index="4">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" style="" underline="0" strikethrough="0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
    ...
    <attributeEditorField verticalStretch="0" horizontalStretch="0" name="Annotation" showLabel="1" index="8">
      <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
        <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" style="" underline="0" strikethrough="0" bold="0"/>
      </labelStyle>
    </attributeEditorField>
  ...
  <labelOnTop>
    ...
    <field name="Curve_TS" labelOnTop="0"/>
    <field name="Elevation" labelOnTop="0"/>
    <field name="FixedStage" labelOnTop="0"/>
    <field name="FlapGate" labelOnTop="0"/>
    <field name="Name" labelOnTop="0"/>
    <field name="RouteTo" labelOnTop="0"/>
