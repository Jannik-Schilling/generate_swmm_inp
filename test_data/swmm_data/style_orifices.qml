...
<qgis symbologyReferenceScale="-1" simplifyAlgorithm="0" simplifyLocal="1" readOnly="0" simplifyDrawingTol="1" version="3.32.0-Lima" maxScale="0" minScale="100000000" labelsEnabled="0" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" simplifyDrawingHints="1">
  ...
  <elevation extrusionEnabled="0" extrusion="0" type="IndividualFeatures" zscale="1" respectLayerSymbol="1" symbology="Line" binding="Centroid" showMarkerSymbolInSurfacePlots="0" zoffset="0" clamping="Terrain">
    ...
    <profileLineSymbol>
      <symbol clip_to_extent="1" alpha="1" type="line" force_rhr="0" is_animated="0" name="" frame_rate="10">
        ...
        <layer pass="0" locked="0" enabled="1" id="{c9f0aa35-a8f7-4381-819f-797516fa949f}" class="SimpleLine">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol clip_to_extent="1" alpha="1" type="fill" force_rhr="0" is_animated="0" name="" frame_rate="10">
        ...
        <layer pass="0" locked="0" enabled="1" id="{70f80b68-454e-426f-82d9-8a5469081698}" class="SimpleFill">
          <Option type="Map">
            ...
            <Option type="QString" value="3x:0,0,0,0,0,0" name="offset_map_unit_scale"/>
            <Option type="QString" value="MM" name="offset_unit"/>
            <Option type="QString" value="136,148,57,255" name="outline_color"/>
    ...
    <profileMarkerSymbol>
      <symbol clip_to_extent="1" alpha="1" type="marker" force_rhr="0" is_animated="0" name="" frame_rate="10">
        ...
        <layer pass="0" locked="0" enabled="1" id="{27b10cda-c344-4e96-ba42-6f4264c64742}" class="SimpleMarker">
          <Option type="Map">
  ...
  <renderer-v2 enableorderby="0" type="singleSymbol" symbollevels="0" referencescale="-1" forceraster="0">
    <symbols>
      <symbol clip_to_extent="1" alpha="1" type="line" force_rhr="0" is_animated="0" name="0" frame_rate="10">
        ...
        <layer pass="0" locked="0" enabled="1" id="{86f2934e-ff8e-40d4-9595-4233d58c81ee}" class="MarkerLine">
          <Option type="Map">
          ...
          <symbol clip_to_extent="1" alpha="1" type="marker" force_rhr="0" is_animated="0" name="@0@0" frame_rate="10">
            ...
            <layer pass="0" locked="0" enabled="1" id="{7be06d46-aae1-495c-859a-64b9379d6f0b}" class="SimpleMarker">
              <Option type="Map">
            ...
            <layer pass="0" locked="0" enabled="1" id="{cc615772-acce-4c72-adbf-a5e499a90405}" class="SimpleMarker">
              <Option type="Map">
                <Option type="QString" value="0" name="angle"/>
                <Option type="QString" value="square" name="cap_style"/>
                <Option type="QString" value="0,0,0,255" name="color"/>
        ...
        <layer pass="0" locked="0" enabled="1" id="{35756b7d-533b-465e-b08f-891227f437d6}" class="SimpleLine">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
    ...
    <DiagramCategory spacing="5" spacingUnitScale="3x:0,0,0,0,0,0" labelPlacementMethod="XHeight" penAlpha="255" minScaleDenominator="0" height="15" scaleBasedVisibility="0" diagramOrientation="Up" spacingUnit="MM" sizeType="MM" minimumSize="0" enabled="0" showAxis="1" barWidth="5" opacity="1" penWidth="0" lineSizeType="MM" direction="0" lineSizeScale="3x:0,0,0,0,0,0" scaleDependency="Area" sizeScale="3x:0,0,0,0,0,0" penColor="#000000" backgroundColor="#ffffff" backgroundAlpha="255" rotationOffset="270" width="15" maxScaleDenominator="1e+08">
      ...
      <axisSymbol>
        <symbol clip_to_extent="1" alpha="1" type="line" force_rhr="0" is_animated="0" name="" frame_rate="10">
          ...
          <layer pass="0" locked="0" enabled="1" id="{a24b814f-876b-4328-8451-8ca54c576765}" class="SimpleLine">
            <Option type="Map">
              <Option type="QString" value="0" name="align_dash_pattern"/>
              <Option type="QString" value="square" name="capstyle"/>
              <Option type="QString" value="5;2" name="customdash"/>
  ...
  <aliases>
    ...
    <alias name="" field="Shape" index="9"/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" expression="" field="CloseTime"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" notnull_strength="0" constraints="0" field="CloseTime" unique_strength="0"/>
    <constraint exp_strength="0" notnull_strength="0" constraints="0" field="Shape" unique_strength="0"/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column width="-1" type="field" name="CloseTime" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer groupBox="0" verticalStretch="0" collapsedExpressionEnabled="0" type="Tab" horizontalStretch="0" collapsed="0" collapsedExpression="" visibilityExpressionEnabled="0" visibilityExpression="" name="Opening" columnCount="1" showLabel="1">
      <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
        <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" style="" underline="0" strikethrough="0" bold="0"/>
      </labelStyle>
      ...
      <attributeEditorField verticalStretch="0" horizontalStretch="0" name="InOffset" showLabel="1" index="5">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" style="" underline="0" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      ...
      <attributeEditorField verticalStretch="0" horizontalStretch="0" name="CloseTime" showLabel="1" index="8">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" style="" underline="0" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField verticalStretch="0" horizontalStretch="0" name="Shape" showLabel="1" index="9">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" style="" underline="0" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField verticalStretch="0" horizontalStretch="0" name="Height" showLabel="1" index="10">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" style="" underline="0" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField verticalStretch="0" horizontalStretch="0" name="Width" showLabel="1" index="11">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" style="" underline="0" strikethrough="0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorField verticalStretch="0" horizontalStretch="0" name="Annotation" showLabel="1" index="12">
      <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
        <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" style="" underline="0" strikethrough="0" bold="0"/>
      </labelStyle>
    </attributeEditorField>
