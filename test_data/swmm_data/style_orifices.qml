...
<qgis hasScaleBasedVisibilityFlag="0" minScale="100000000" styleCategories="AllStyleCategories" simplifyDrawingHints="1" labelsEnabled="0" symbologyReferenceScale="-1" simplifyMaxScale="1" version="3.30.3-'s-Hertogenbosch" maxScale="0" readOnly="0" simplifyDrawingTol="1" simplifyAlgorithm="0" simplifyLocal="1">
  ...
  <elevation type="IndividualFeatures" zscale="1" extrusion="0" clamping="Terrain" symbology="Line" zoffset="0" binding="Centroid" showMarkerSymbolInSurfacePlots="0" extrusionEnabled="0" respectLayerSymbol="1">
    ...
    <profileLineSymbol>
      <symbol type="line" frame_rate="10" name="" alpha="1" clip_to_extent="1" force_rhr="0" is_animated="0">
        ...
        <layer enabled="1" id="{c9f0aa35-a8f7-4381-819f-797516fa949f}" class="SimpleLine" locked="0" pass="0">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol type="fill" frame_rate="10" name="" alpha="1" clip_to_extent="1" force_rhr="0" is_animated="0">
        ...
        <layer enabled="1" id="{70f80b68-454e-426f-82d9-8a5469081698}" class="SimpleFill" locked="0" pass="0">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol type="marker" frame_rate="10" name="" alpha="1" clip_to_extent="1" force_rhr="0" is_animated="0">
        ...
        <layer enabled="1" id="{27b10cda-c344-4e96-ba42-6f4264c64742}" class="SimpleMarker" locked="0" pass="0">
          <Option type="Map">
  ...
  <renderer-v2 type="singleSymbol" enableorderby="0" forceraster="0" symbollevels="0" referencescale="-1">
    <symbols>
      <symbol type="line" frame_rate="10" name="0" alpha="1" clip_to_extent="1" force_rhr="0" is_animated="0">
        ...
        <layer enabled="1" id="{86f2934e-ff8e-40d4-9595-4233d58c81ee}" class="MarkerLine" locked="0" pass="0">
          <Option type="Map">
          ...
          <symbol type="marker" frame_rate="10" name="@0@0" alpha="1" clip_to_extent="1" force_rhr="0" is_animated="0">
            ...
            <layer enabled="1" id="{7be06d46-aae1-495c-859a-64b9379d6f0b}" class="SimpleMarker" locked="0" pass="0">
              <Option type="Map">
            ...
            <layer enabled="1" id="{cc615772-acce-4c72-adbf-a5e499a90405}" class="SimpleMarker" locked="0" pass="0">
              <Option type="Map">
                <Option type="QString" name="angle" value="0"/>
                <Option type="QString" name="cap_style" value="square"/>
                <Option type="QString" name="color" value="0,0,0,255"/>
        ...
        <layer enabled="1" id="{35756b7d-533b-465e-b08f-891227f437d6}" class="SimpleLine" locked="0" pass="0">
          <Option type="Map">
            <Option type="QString" name="align_dash_pattern" value="0"/>
            <Option type="QString" name="capstyle" value="square"/>
            <Option type="QString" name="customdash" value="5;2"/>
    ...
    <DiagramCategory scaleDependency="Area" showAxis="1" sizeType="MM" lineSizeType="MM" spacingUnit="MM" lineSizeScale="3x:0,0,0,0,0,0" labelPlacementMethod="XHeight" rotationOffset="270" backgroundColor="#ffffff" backgroundAlpha="255" maxScaleDenominator="1e+08" penWidth="0" minimumSize="0" width="15" sizeScale="3x:0,0,0,0,0,0" scaleBasedVisibility="0" spacing="5" spacingUnitScale="3x:0,0,0,0,0,0" enabled="0" direction="0" barWidth="5" penAlpha="255" diagramOrientation="Up" height="15" penColor="#000000" opacity="1" minScaleDenominator="0">
      ...
      <axisSymbol>
        <symbol type="line" frame_rate="10" name="" alpha="1" clip_to_extent="1" force_rhr="0" is_animated="0">
          ...
          <layer enabled="1" id="{a24b814f-876b-4328-8451-8ca54c576765}" class="SimpleLine" locked="0" pass="0">
            <Option type="Map">
              <Option type="QString" name="align_dash_pattern" value="0"/>
              <Option type="QString" name="capstyle" value="square"/>
              <Option type="QString" name="customdash" value="5;2"/>
        ...
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" name="BOTTOM" value="BOTTOM"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="SIDE" value="SIDE"/>
              </Option>
            </Option>
          </Option>
        </config>
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              ...
              <Option type="QString" name="RECT_CLOSED" value="RECT_CLOSED"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <defaults>
    ...
    <default field="CloseTime" applyOnUpdate="0" expression=""/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" field="CloseTime" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint notnull_strength="0" field="Shape" exp_strength="0" constraints="0" unique_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="CloseTime" desc=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column width="-1" type="field" hidden="0" name="CloseTime"/>
      <column width="-1" type="field" hidden="0" name="Shape"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer visibilityExpressionEnabled="0" visibilityExpression="" name="Opening" groupBox="0" columnCount="1" collapsed="0" collapsedExpression="" showLabel="1" collapsedExpressionEnabled="0">
      <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
        <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" underline="0" strikethrough="0" italic="0" style="" bold="0"/>
      </labelStyle>
      ...
      <attributeEditorField name="InOffset" showLabel="1" index="5">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" underline="0" strikethrough="0" italic="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      ...
      <attributeEditorField name="CloseTime" showLabel="1" index="8">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" underline="0" strikethrough="0" italic="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="Shape" showLabel="1" index="9">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" underline="0" strikethrough="0" italic="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="Height" showLabel="1" index="10">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" underline="0" strikethrough="0" italic="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="Width" showLabel="1" index="11">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" underline="0" strikethrough="0" italic="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    </attributeEditorContainer>
    <attributeEditorField name="Annotation" showLabel="1" index="12">
      <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
        <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" underline="0" strikethrough="0" italic="0" style="" bold="0"/>
      </labelStyle>
    </attributeEditorField>
    <attributeEditorAction ActionUUID="{ca8c8caa-82d8-4296-b27f-d442459e6195}" name="{ca8c8caa-82d8-4296-b27f-d442459e6195}" showLabel="1">
      <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
        <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" underline="0" strikethrough="0" italic="0" style="" bold="0"/>
      </labelStyle>
