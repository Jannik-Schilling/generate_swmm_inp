...
<qgis simplifyDrawingHints="1" minScale="100000000" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyAlgorithm="0" readOnly="0" maxScale="0" symbologyReferenceScale="-1" version="3.30.3-'s-Hertogenbosch" simplifyLocal="1">
  ...
  <elevation symbology="Line" showMarkerSymbolInSurfacePlots="0" extrusion="0" binding="Centroid" zoffset="0" respectLayerSymbol="1" extrusionEnabled="0" zscale="1" clamping="Terrain" type="IndividualFeatures">
    ...
    <profileLineSymbol>
      <symbol frame_rate="10" alpha="1" is_animated="0" force_rhr="0" clip_to_extent="1" type="line" name="">
        ...
        <layer pass="0" locked="0" id="{c9f0aa35-a8f7-4381-819f-797516fa949f}" enabled="1" class="SimpleLine">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol frame_rate="10" alpha="1" is_animated="0" force_rhr="0" clip_to_extent="1" type="fill" name="">
        ...
        <layer pass="0" locked="0" id="{70f80b68-454e-426f-82d9-8a5469081698}" enabled="1" class="SimpleFill">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol frame_rate="10" alpha="1" is_animated="0" force_rhr="0" clip_to_extent="1" type="marker" name="">
        ...
        <layer pass="0" locked="0" id="{27b10cda-c344-4e96-ba42-6f4264c64742}" enabled="1" class="SimpleMarker">
          <Option type="Map">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" enableorderby="0" type="singleSymbol" referencescale="-1">
    <symbols>
      <symbol frame_rate="10" alpha="1" is_animated="0" force_rhr="0" clip_to_extent="1" type="line" name="0">
        ...
        <layer pass="0" locked="0" id="{86f2934e-ff8e-40d4-9595-4233d58c81ee}" enabled="1" class="MarkerLine">
          <Option type="Map">
          ...
          <symbol frame_rate="10" alpha="1" is_animated="0" force_rhr="0" clip_to_extent="1" type="marker" name="@0@0">
            ...
            <layer pass="0" locked="0" id="{7be06d46-aae1-495c-859a-64b9379d6f0b}" enabled="1" class="SimpleMarker">
              <Option type="Map">
            ...
            <layer pass="0" locked="0" id="{cc615772-acce-4c72-adbf-a5e499a90405}" enabled="1" class="SimpleMarker">
              <Option type="Map">
                <Option value="0" type="QString" name="angle"/>
                <Option value="square" type="QString" name="cap_style"/>
                <Option value="0,0,0,255" type="QString" name="color"/>
        ...
        <layer pass="0" locked="0" id="{35756b7d-533b-465e-b08f-891227f437d6}" enabled="1" class="SimpleLine">
          <Option type="Map">
            <Option value="0" type="QString" name="align_dash_pattern"/>
            <Option value="square" type="QString" name="capstyle"/>
            <Option value="5;2" type="QString" name="customdash"/>
    ...
    <DiagramCategory penColor="#000000" lineSizeScale="3x:0,0,0,0,0,0" barWidth="5" showAxis="1" sizeScale="3x:0,0,0,0,0,0" opacity="1" scaleDependency="Area" maxScaleDenominator="1e+08" spacingUnit="MM" lineSizeType="MM" labelPlacementMethod="XHeight" penWidth="0" backgroundAlpha="255" width="15" rotationOffset="270" spacingUnitScale="3x:0,0,0,0,0,0" direction="0" enabled="0" minScaleDenominator="0" penAlpha="255" backgroundColor="#ffffff" spacing="5" height="15" scaleBasedVisibility="0" sizeType="MM" diagramOrientation="Up" minimumSize="0">
      ...
      <axisSymbol>
        <symbol frame_rate="10" alpha="1" is_animated="0" force_rhr="0" clip_to_extent="1" type="line" name="">
          ...
          <layer pass="0" locked="0" id="{a24b814f-876b-4328-8451-8ca54c576765}" enabled="1" class="SimpleLine">
            <Option type="Map">
              <Option value="0" type="QString" name="align_dash_pattern"/>
              <Option value="square" type="QString" name="capstyle"/>
              <Option value="5;2" type="QString" name="customdash"/>
  ...
  <fieldConfiguration>
        ...
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option value="BOTTOM" type="QString" name="BOTTOM"/>
              </Option>
              <Option type="Map">
    ...
    <field configurationFlags="None" name="CloseTime">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias index="5" field="InOffset" name=""/>
    <alias index="6" field="Qcoeff" name=""/>
    <alias index="7" field="FlapGate" name=""/>
    <alias index="8" field="CloseTime" name=""/>
    <alias index="9" field="Shape" name=""/>
    <alias index="10" field="Height" name=""/>
    <alias index="11" field="Width" name=""/>
    <alias index="12" field="Annotation" name=""/>
  </aliases>
  <splitPolicies>
    ...
    <policy policy="Duplicate" field="CloseTime"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" field="CloseTime" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="Shape" unique_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" field="CloseTime" exp=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" width="-1" type="field" name="CloseTime"/>
      <column hidden="0" width="-1" type="field" name="Shape"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" columnCount="1" collapsedExpression="" showLabel="1" groupBox="0" collapsed="0" visibilityExpressionEnabled="0" visibilityExpression="" name="Opening">
      <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
        <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
      </labelStyle>
      ...
      <attributeEditorField index="5" showLabel="1" name="InOffset">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
        </labelStyle>
      </attributeEditorField>
      ...
      <attributeEditorField index="8" showLabel="1" name="CloseTime">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="9" showLabel="1" name="Shape">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="10" showLabel="1" name="Height">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="11" showLabel="1" name="Width">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorField index="12" showLabel="1" name="Annotation">
      <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
        <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
      </labelStyle>
    </attributeEditorField>
