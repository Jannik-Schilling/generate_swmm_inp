...
<qgis simplifyDrawingHints="0" minScale="0" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyAlgorithm="0" readOnly="0" maxScale="0" symbologyReferenceScale="-1" version="3.30.3-'s-Hertogenbosch" simplifyLocal="1">
  <flags>
  ...
  <elevation symbology="Line" showMarkerSymbolInSurfacePlots="0" extrusion="0" binding="Centroid" zoffset="0" respectLayerSymbol="1" extrusionEnabled="0" zscale="1" clamping="Terrain" type="IndividualFeatures">
    ...
    <profileLineSymbol>
      <symbol frame_rate="10" alpha="1" is_animated="0" force_rhr="0" clip_to_extent="1" type="line" name="">
        ...
        <layer pass="0" locked="0" id="{dcc1e989-be45-450b-bc4b-4bc44078f730}" enabled="1" class="SimpleLine">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol frame_rate="10" alpha="1" is_animated="0" force_rhr="0" clip_to_extent="1" type="fill" name="">
        ...
        <layer pass="0" locked="0" id="{c6f5bbfa-fd00-419c-9e6e-fcf505d2f71e}" enabled="1" class="SimpleFill">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol frame_rate="10" alpha="1" is_animated="0" force_rhr="0" clip_to_extent="1" type="marker" name="">
        ...
        <layer pass="0" locked="0" id="{4ac7da1a-db59-4d21-a5af-27a35d6e2098}" enabled="1" class="SimpleMarker">
          <Option type="Map">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" enableorderby="0" type="singleSymbol" referencescale="-1">
    <symbols>
      <symbol frame_rate="10" alpha="1" is_animated="0" force_rhr="0" clip_to_extent="1" type="marker" name="0">
        ...
        <layer pass="0" locked="0" id="{bc660098-5520-4a97-8b95-e8f6beec0bd9}" enabled="1" class="SimpleMarker">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="square" type="QString" name="cap_style"/>
    ...
    <DiagramCategory penColor="#000000" lineSizeScale="3x:0,0,0,0,0,0" barWidth="5" showAxis="1" sizeScale="3x:0,0,0,0,0,0" opacity="1" scaleDependency="Area" maxScaleDenominator="0" spacingUnit="MM" lineSizeType="MM" labelPlacementMethod="XHeight" penWidth="0" backgroundAlpha="255" width="15" rotationOffset="270" spacingUnitScale="3x:0,0,0,0,0,0" direction="0" enabled="0" minScaleDenominator="0" penAlpha="255" backgroundColor="#ffffff" spacing="5" height="15" scaleBasedVisibility="0" sizeType="MM" diagramOrientation="Up" minimumSize="0">
      ...
      <axisSymbol>
        <symbol frame_rate="10" alpha="1" is_animated="0" force_rhr="0" clip_to_extent="1" type="line" name="">
          ...
          <layer pass="0" locked="0" id="{62d54a06-6bcb-421c-a088-3a021a4586c1}" enabled="1" class="SimpleLine">
            <Option type="Map">
              <Option value="0" type="QString" name="align_dash_pattern"/>
              <Option value="square" type="QString" name="capstyle"/>
              <Option value="5;2" type="QString" name="customdash"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="Coeff">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option value="false" type="bool" name="IsMultiline"/>
    ...
    <field configurationFlags="None" name="Exponent">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option value="false" type="bool" name="IsMultiline"/>
    ...
    <field configurationFlags="None" name="Constant">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option value="false" type="bool" name="IsMultiline"/>
    ...
    <field configurationFlags="None" name="MajorAxis">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option value="false" type="bool" name="IsMultiline"/>
    ...
    <field configurationFlags="None" name="MinorAxis">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option value="false" type="bool" name="IsMultiline"/>
    ...
    <field configurationFlags="None" name="SurfHeight">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option value="false" type="bool" name="IsMultiline"/>
    ...
    <field configurationFlags="None" name="Fevap">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option value="false" type="bool" name="IsMultiline"/>
    ...
    <field configurationFlags="None" name="Psi">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option value="false" type="bool" name="IsMultiline"/>
    ...
    <field configurationFlags="None" name="Ksat">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option value="false" type="bool" name="IsMultiline"/>
    ...
    <field configurationFlags="None" name="IMD">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option value="false" type="bool" name="IsMultiline"/>
  ...
  <aliases>
    ...
    <alias index="3" field="MaxDepth" name=""/>
    <alias index="4" field="InitDepth" name=""/>
    <alias index="5" field="Type" name=""/>
    <alias index="6" field="Curve" name=""/>
    <alias index="7" field="Coeff" name=""/>
    <alias index="8" field="Exponent" name=""/>
    <alias index="9" field="Constant" name=""/>
    <alias index="10" field="MajorAxis" name=""/>
    <alias index="11" field="MinorAxis" name=""/>
    <alias index="12" field="SideSlope" name=""/>
    <alias index="13" field="SurfHeight" name=""/>
    <alias index="14" field="SurDepth" name=""/>
    <alias index="15" field="Fevap" name=""/>
    <alias index="16" field="Psi" name=""/>
    <alias index="17" field="Ksat" name=""/>
    <alias index="18" field="IMD" name=""/>
    <alias index="19" field="Annotation" name=""/>
  </aliases>
  <splitPolicies>
    ...
    <policy policy="Duplicate" field="Coeff"/>
    <policy policy="Duplicate" field="Exponent"/>
    <policy policy="Duplicate" field="Constant"/>
    <policy policy="Duplicate" field="MajorAxis"/>
    <policy policy="Duplicate" field="MinorAxis"/>
    <policy policy="Duplicate" field="SideSlope"/>
    <policy policy="Duplicate" field="SurfHeight"/>
    <policy policy="Duplicate" field="SurDepth"/>
    <policy policy="Duplicate" field="Fevap"/>
    <policy policy="Duplicate" field="Psi"/>
    <policy policy="Duplicate" field="Ksat"/>
    <policy policy="Duplicate" field="IMD"/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="Coeff" expression=""/>
    <default applyOnUpdate="0" field="Exponent" expression=""/>
    <default applyOnUpdate="0" field="Constant" expression=""/>
    <default applyOnUpdate="0" field="MajorAxis" expression=""/>
    <default applyOnUpdate="0" field="MinorAxis" expression=""/>
    <default applyOnUpdate="0" field="SideSlope" expression=""/>
    <default applyOnUpdate="0" field="SurfHeight" expression=""/>
    <default applyOnUpdate="0" field="SurDepth" expression=""/>
    <default applyOnUpdate="0" field="Fevap" expression=""/>
    <default applyOnUpdate="0" field="Psi" expression=""/>
    <default applyOnUpdate="0" field="Ksat" expression=""/>
    <default applyOnUpdate="0" field="IMD" expression=""/>
  ...
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" field="MaxDepth" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="InitDepth" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="Type" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="Curve" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="Coeff" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="Exponent" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="Constant" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="MajorAxis" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="MinorAxis" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="SideSlope" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="SurfHeight" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="SurDepth" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="Fevap" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="Psi" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="Ksat" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="IMD" unique_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" field="Coeff" exp=""/>
    <constraint desc="" field="Exponent" exp=""/>
    <constraint desc="" field="Constant" exp=""/>
    <constraint desc="" field="MajorAxis" exp=""/>
    <constraint desc="" field="MinorAxis" exp=""/>
    <constraint desc="" field="SideSlope" exp=""/>
    <constraint desc="" field="SurfHeight" exp=""/>
    <constraint desc="" field="SurDepth" exp=""/>
    <constraint desc="" field="Fevap" exp=""/>
    <constraint desc="" field="Psi" exp=""/>
    <constraint desc="" field="Ksat" exp=""/>
    <constraint desc="" field="IMD" exp=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" width="-1" type="field" name="Curve"/>
      <column hidden="0" width="-1" type="field" name="Coeff"/>
      <column hidden="0" width="-1" type="field" name="Exponent"/>
      <column hidden="0" width="-1" type="field" name="Constant"/>
      <column hidden="0" width="-1" type="field" name="MajorAxis"/>
      <column hidden="0" width="-1" type="field" name="MinorAxis"/>
      <column hidden="0" width="-1" type="field" name="SideSlope"/>
      <column hidden="0" width="-1" type="field" name="SurfHeight"/>
      <column hidden="0" width="-1" type="field" name="SurDepth"/>
      <column hidden="0" width="-1" type="field" name="Fevap"/>
      <column hidden="0" width="-1" type="field" name="Psi"/>
      <column hidden="0" width="-1" type="field" name="Ksat"/>
      <column hidden="0" width="-1" type="field" name="IMD"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" columnCount="1" collapsedExpression="" showLabel="1" groupBox="0" collapsed="0" visibilityExpressionEnabled="0" visibilityExpression="" name="General">
      ...
      <attributeEditorField index="3" showLabel="1" name="MaxDepth">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="4" showLabel="1" name="InitDepth">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="14" showLabel="1" name="SurDepth">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="15" showLabel="1" name="Fevap">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
        </labelStyle>
      </attributeEditorField>
    </attributeEditorContainer>
    <attributeEditorContainer collapsedExpressionEnabled="0" columnCount="1" collapsedExpression="" showLabel="1" groupBox="0" collapsed="0" visibilityExpressionEnabled="0" visibilityExpression="" name="Storage seepage">
      <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
        <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
      </labelStyle>
      <attributeEditorField index="16" showLabel="1" name="Psi">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="17" showLabel="1" name="Ksat">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField index="18" showLabel="1" name="IMD">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
        </labelStyle>
      </attributeEditorField>
    </attributeEditorContainer>
    <attributeEditorContainer collapsedExpressionEnabled="0" columnCount="1" collapsedExpression="" showLabel="1" groupBox="0" collapsed="0" visibilityExpressionEnabled="0" visibilityExpression="" name="Storage shape">
      <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
        <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
      </labelStyle>
      ...
      <attributeEditorContainer collapsedExpressionEnabled="0" columnCount="1" collapsedExpression="" showLabel="1" groupBox="1" collapsed="0" visibilityExpressionEnabled="1" visibilityExpression="&quot;Type&quot; =  'CONICAL' " name="Conical">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
        </labelStyle>
        <attributeEditorField index="10" showLabel="1" name="MajorAxis">
          <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
            <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField index="11" showLabel="1" name="MinorAxis">
          <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
            <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField index="12" showLabel="1" name="SideSlope">
          <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
            <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
          </labelStyle>
        </attributeEditorField>
      </attributeEditorContainer>
      <attributeEditorContainer collapsedExpressionEnabled="0" columnCount="1" collapsedExpression="" showLabel="1" groupBox="1" collapsed="0" visibilityExpressionEnabled="1" visibilityExpression="&quot;Type&quot; =  'CYLINDRICAL' " name="Cylindrical">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
        </labelStyle>
        <attributeEditorField index="10" showLabel="1" name="MajorAxis">
      ...
      <attributeEditorContainer collapsedExpressionEnabled="0" columnCount="1" collapsedExpression="" showLabel="1" groupBox="1" collapsed="0" visibilityExpressionEnabled="1" visibilityExpression="&quot;Type&quot; = 'FUNCTIONAL'" name="Functional">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
        </labelStyle>
        <attributeEditorField index="9" showLabel="1" name="Constant">
          <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
            <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField index="7" showLabel="1" name="Coeff">
          <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
            <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField index="8" showLabel="1" name="Exponent">
          <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
            <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
          </labelStyle>
        </attributeEditorField>
      </attributeEditorContainer>
      <attributeEditorContainer collapsedExpressionEnabled="0" columnCount="1" collapsedExpression="" showLabel="1" groupBox="1" collapsed="0" visibilityExpressionEnabled="1" visibilityExpression="&quot;Type&quot; =  'TABULAR' " name="Tabular">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
        </labelStyle>
      ...
      <attributeEditorContainer collapsedExpressionEnabled="0" columnCount="1" collapsedExpression="" showLabel="1" groupBox="1" collapsed="0" visibilityExpressionEnabled="1" visibilityExpression="&quot;Type&quot; =  'PYRAMIDAL' " name="Pyramidal">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
        </labelStyle>
        <attributeEditorField index="10" showLabel="1" name="MajorAxis">
      ...
      <attributeEditorContainer collapsedExpressionEnabled="0" columnCount="1" collapsedExpression="" showLabel="1" groupBox="1" collapsed="0" visibilityExpressionEnabled="1" visibilityExpression="&quot;Type&quot; =  'PARABOLIC' " name="Parabolic">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
        </labelStyle>
        <attributeEditorField index="10" showLabel="1" name="MajorAxis">
        ...
        <attributeEditorField index="13" showLabel="1" name="SurfHeight">
          <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
            <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
          </labelStyle>
        </attributeEditorField>
    ...
    <attributeEditorField index="19" showLabel="1" name="Annotation">
      <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
        <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
      </labelStyle>
    </attributeEditorField>
