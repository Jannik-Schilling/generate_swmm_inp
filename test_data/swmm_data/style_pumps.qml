...
<qgis hasScaleBasedVisibilityFlag="0" minScale="0" styleCategories="AllStyleCategories" simplifyDrawingHints="1" labelsEnabled="0" symbologyReferenceScale="-1" simplifyMaxScale="1" version="3.30.3-'s-Hertogenbosch" maxScale="0" readOnly="0" simplifyDrawingTol="1" simplifyAlgorithm="0" simplifyLocal="1">
  <flags>
  ...
  <elevation type="IndividualFeatures" zscale="1" extrusion="0" clamping="Terrain" symbology="Line" zoffset="0" binding="Centroid" showMarkerSymbolInSurfacePlots="0" extrusionEnabled="0" respectLayerSymbol="1">
    ...
    <profileLineSymbol>
      <symbol type="line" frame_rate="10" name="" alpha="1" clip_to_extent="1" force_rhr="0" is_animated="0">
        ...
        <layer enabled="1" id="{41e60215-b9fb-4d02-8252-b5650dcf426e}" class="SimpleLine" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option type="QString" name="line_color" value="229,182,54,255"/>
    ...
    <profileFillSymbol>
      <symbol type="fill" frame_rate="10" name="" alpha="1" clip_to_extent="1" force_rhr="0" is_animated="0">
        ...
        <layer enabled="1" id="{f903152b-cf5f-49bb-b6f4-d906d8710e57}" class="SimpleFill" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="offset_unit" value="MM"/>
            <Option type="QString" name="outline_color" value="164,130,39,255"/>
    ...
    <profileMarkerSymbol>
      <symbol type="marker" frame_rate="10" name="" alpha="1" clip_to_extent="1" force_rhr="0" is_animated="0">
        ...
        <layer enabled="1" id="{724dc495-96ed-4d78-8f56-ec85ef0e4968}" class="SimpleMarker" locked="0" pass="0">
          <Option type="Map">
  ...
  <renderer-v2 type="singleSymbol" enableorderby="0" forceraster="0" symbollevels="0" referencescale="-1">
    <symbols>
      <symbol type="line" frame_rate="10" name="0" alpha="1" clip_to_extent="1" force_rhr="0" is_animated="0">
        ...
        <layer enabled="1" id="{25a34ffd-6e98-42cf-b2f9-07b8aca42e16}" class="SimpleLine" locked="0" pass="0">
          <Option type="Map">
            <Option type="QString" name="align_dash_pattern" value="0"/>
            <Option type="QString" name="capstyle" value="square"/>
            <Option type="QString" name="customdash" value="5;2"/>
            ...
            <Option type="QString" name="draw_inside_polygon" value="0"/>
            <Option type="QString" name="joinstyle" value="bevel"/>
            <Option type="QString" name="line_color" value="72,72,72,255"/>
        ...
        <layer enabled="1" id="{a7815b75-ba9c-43dd-b0fd-003c79b6de73}" class="MarkerLine" locked="0" pass="0">
          <Option type="Map">
          ...
          <symbol type="marker" frame_rate="10" name="@0@1" alpha="1" clip_to_extent="1" force_rhr="0" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" name="name" value=""/>
                <Option name="properties"/>
            ...
            <layer enabled="1" id="{97f143a8-9bb1-4a99-bdb1-7a3d6f8b2dfb}" class="SimpleMarker" locked="0" pass="0">
              <Option type="Map">
                <Option type="QString" name="angle" value="0"/>
                <Option type="QString" name="cap_style" value="square"/>
                <Option type="QString" name="color" value="74,74,74,255"/>
                <Option type="QString" name="horizontal_anchor_point" value="1"/>
                <Option type="QString" name="joinstyle" value="bevel"/>
                ...
                <Option type="Map">
                  ...
                  <Option type="Map" name="properties">
                    <Option type="Map" name="size">
                      ...
                      <Option type="QString" name="expression" value="if( @map_scale> 4000 ,1.8*4000/@map_scale,1.8)"/>
        ...
        <layer enabled="1" id="{58313ce7-7e23-466b-b870-5c8e03f4a122}" class="MarkerLine" locked="0" pass="0">
          <Option type="Map">
            <Option type="QString" name="average_angle_length" value="5.2"/>
            <Option type="QString" name="average_angle_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="average_angle_unit" value="MM"/>
            <Option type="QString" name="interval" value="3"/>
            <Option type="QString" name="interval_map_unit_scale" value="3x:0,0,0,0,0,0"/>
          ...
          <symbol type="marker" frame_rate="10" name="@0@2" alpha="1" clip_to_extent="1" force_rhr="0" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" name="name" value=""/>
                <Option name="properties"/>
            ...
            <layer enabled="1" id="{a819204d-a05a-42cb-8898-1b4b0200a700}" class="SimpleMarker" locked="0" pass="0">
              <Option type="Map">
                ...
                <Option type="QString" name="offset" value="0,-0.90000000000000024"/>
                <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
                <Option type="QString" name="offset_unit" value="MM"/>
                <Option type="QString" name="outline_color" value="35,35,35,255"/>
                ...
                <Option type="Map">
                  ...
                  <Option type="Map" name="properties">
                    <Option type="Map" name="offset">
                      <Option type="bool" name="active" value="true"/>
                      <Option type="QString" name="expression" value="'0'|| ',' || tostring(-0.5*(if( @map_scale> 4000 ,1.8*4000/@map_scale,1.8)))"/>
                      <Option type="int" name="type" value="3"/>
                    </Option>
                    <Option type="Map" name="size">
                      <Option type="bool" name="active" value="true"/>
    ...
    <DiagramCategory scaleDependency="Area" showAxis="1" sizeType="MM" lineSizeType="MM" spacingUnit="MM" lineSizeScale="3x:0,0,0,0,0,0" labelPlacementMethod="XHeight" rotationOffset="270" backgroundColor="#ffffff" backgroundAlpha="255" maxScaleDenominator="0" penWidth="0" minimumSize="0" width="15" sizeScale="3x:0,0,0,0,0,0" scaleBasedVisibility="0" spacing="5" spacingUnitScale="3x:0,0,0,0,0,0" enabled="0" direction="0" barWidth="5" penAlpha="255" diagramOrientation="Up" height="15" penColor="#000000" opacity="1" minScaleDenominator="0">
      ...
      <axisSymbol>
        <symbol type="line" frame_rate="10" name="" alpha="1" clip_to_extent="1" force_rhr="0" is_animated="0">
          ...
          <layer enabled="1" id="{6aa8b91d-4d0d-4f7c-8b40-7ac154d1646f}" class="SimpleLine" locked="0" pass="0">
            <Option type="Map">
              <Option type="QString" name="align_dash_pattern" value="0"/>
              <Option type="QString" name="capstyle" value="square"/>
              <Option type="QString" name="customdash" value="5;2"/>
        ...
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" name="OFF" value="OFF"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="ON" value="ON"/>
              </Option>
            </Option>
          </Option>
        </config>
  ...
  <defaults>
    ...
    <default field="PumpCurve" applyOnUpdate="0" expression=""/>
    <default field="Status" applyOnUpdate="0" expression=""/>
    <default field="Startup" applyOnUpdate="0" expression=""/>
    <default field="Shutoff" applyOnUpdate="0" expression=""/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" field="PumpCurve" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint notnull_strength="0" field="Status" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint notnull_strength="0" field="Startup" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint notnull_strength="0" field="Shutoff" exp_strength="0" constraints="0" unique_strength="0"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column width="-1" type="field" hidden="0" name="PumpCurve"/>
      <column width="-1" type="field" hidden="0" name="Status"/>
      <column width="-1" type="field" hidden="0" name="Startup"/>
      <column width="-1" type="field" hidden="0" name="Shutoff"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer visibilityExpressionEnabled="0" visibilityExpression="" name="General" groupBox="0" columnCount="1" collapsed="0" collapsedExpression="" showLabel="1" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="Shutoff" showLabel="1" index="7">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" underline="0" strikethrough="0" italic="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="Startup" showLabel="1" index="6">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" underline="0" strikethrough="0" italic="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="Status" showLabel="1" index="5">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" underline="0" strikethrough="0" italic="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="PumpCurve" showLabel="1" index="4">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" underline="0" strikethrough="0" italic="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorAction ActionUUID="{ac0ff50a-bf97-4519-88d5-e4de4eb927db}" name="{ac0ff50a-bf97-4519-88d5-e4de4eb927db}" showLabel="1">
      <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
        <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" underline="0" strikethrough="0" italic="0" style="" bold="0"/>
      </labelStyle>
  ...
  <reuseLastValue>
    ...
    <field name="PumpCurve" reuseLastValue="0"/>
    <field name="Shutoff" reuseLastValue="0"/>
    <field name="Startup" reuseLastValue="0"/>
