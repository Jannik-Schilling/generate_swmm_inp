...
<qgis simplifyDrawingHints="0" minScale="0" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyAlgorithm="0" readOnly="0" maxScale="0" symbologyReferenceScale="-1" version="3.30.3-'s-Hertogenbosch" simplifyLocal="1">
  ...
  <elevation symbology="Line" showMarkerSymbolInSurfacePlots="0" extrusion="0" binding="Centroid" zoffset="0" respectLayerSymbol="1" extrusionEnabled="0" zscale="1" clamping="Terrain" type="IndividualFeatures">
    ...
    <profileLineSymbol>
      <symbol frame_rate="10" alpha="1" is_animated="0" force_rhr="0" clip_to_extent="1" type="line" name="">
        ...
        <layer pass="0" locked="0" id="{2bca451d-3974-4fb6-9803-62e01fc7fe03}" enabled="1" class="SimpleLine">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol frame_rate="10" alpha="1" is_animated="0" force_rhr="0" clip_to_extent="1" type="fill" name="">
        ...
        <layer pass="0" locked="0" id="{ba987f59-7658-40e9-a025-7b524d777d59}" enabled="1" class="SimpleFill">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol frame_rate="10" alpha="1" is_animated="0" force_rhr="0" clip_to_extent="1" type="marker" name="">
        ...
        <layer pass="0" locked="0" id="{68d9b70a-60dc-4855-aa01-4ef381181588}" enabled="1" class="SimpleMarker">
          <Option type="Map">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" enableorderby="0" type="singleSymbol" referencescale="-1">
    <symbols>
      <symbol frame_rate="10" alpha="1" is_animated="0" force_rhr="0" clip_to_extent="1" type="marker" name="0">
        ...
        <layer pass="0" locked="0" id="{59361457-7799-4e46-94ed-e63c47ee8460}" enabled="1" class="SimpleMarker">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="square" type="QString" name="cap_style"/>
            ...
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                <Option type="Map" name="size">
                  ...
                  <Option value="if( @map_scale> 6000 ,3.4*6000/@map_scale,3.4)" type="QString" name="expression"/>
    ...
    <DiagramCategory penColor="#000000" lineSizeScale="3x:0,0,0,0,0,0" barWidth="5" showAxis="1" sizeScale="3x:0,0,0,0,0,0" opacity="1" scaleDependency="Area" maxScaleDenominator="0" spacingUnit="MM" lineSizeType="MM" labelPlacementMethod="XHeight" penWidth="0" backgroundAlpha="255" width="15" rotationOffset="270" spacingUnitScale="3x:0,0,0,0,0,0" direction="0" enabled="0" minScaleDenominator="0" penAlpha="255" backgroundColor="#ffffff" spacing="5" height="15" scaleBasedVisibility="0" sizeType="MM" diagramOrientation="Up" minimumSize="0">
      ...
      <axisSymbol>
        <symbol frame_rate="10" alpha="1" is_animated="0" force_rhr="0" clip_to_extent="1" type="line" name="">
          ...
          <layer pass="0" locked="0" id="{852801f3-9134-408d-80bb-a5a75461af36}" enabled="1" class="SimpleLine">
            <Option type="Map">
              <Option value="0" type="QString" name="align_dash_pattern"/>
              <Option value="square" type="QString" name="capstyle"/>
              <Option value="5;2" type="QString" name="customdash"/>
        ...
        <config>
          <Option type="Map">
            <Option type="Map" name="map">
              <Option value="CUTOFF" type="QString" name="CUTOFF"/>
              <Option value="OVERFLOW" type="QString" name="OVERFLOW"/>
  ...
  <aliases>
    ...
    <alias index="3" field="DivertLink" name=""/>
    <alias index="4" field="Type" name=""/>
    <alias index="5" field="CutoffFlow" name=""/>
    <alias index="6" field="Curve" name=""/>
    <alias index="7" field="WeirMinFlo" name=""/>
    <alias index="8" field="WeirMaxDep" name=""/>
    <alias index="9" field="WeirCoeff" name=""/>
    <alias index="10" field="MaxDepth" name=""/>
    <alias index="11" field="InitDepth" name=""/>
    <alias index="12" field="SurDepth" name=""/>
    <alias index="13" field="Aponded" name=""/>
    <alias index="14" field="Annotation" name=""/>
  </aliases>
  <splitPolicies>
  ...
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" field="DivertLink" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="Type" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="CutoffFlow" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="Curve" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="WeirMinFlo" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="WeirMaxDep" unique_strength="0" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" field="WeirCoeff" unique_strength="0" notnull_strength="0"/>
    ...
    <constraint constraints="0" exp_strength="0" field="Aponded" unique_strength="0" notnull_strength="0"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" width="-1" type="field" name="DivertLink"/>
      <column hidden="0" width="-1" type="field" name="Type"/>
      <column hidden="0" width="-1" type="field" name="CutoffFlow"/>
      <column hidden="0" width="-1" type="field" name="Curve"/>
      <column hidden="0" width="-1" type="field" name="WeirMinFlo"/>
      <column hidden="0" width="-1" type="field" name="WeirMaxDep"/>
      <column hidden="0" width="-1" type="field" name="WeirCoeff"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" columnCount="1" collapsedExpression="" showLabel="1" groupBox="0" collapsed="0" visibilityExpressionEnabled="0" visibilityExpression="" name="General">
      ...
      <attributeEditorContainer collapsedExpressionEnabled="0" columnCount="1" collapsedExpression="" showLabel="0" groupBox="1" collapsed="0" visibilityExpressionEnabled="1" visibilityExpression="&quot;Type&quot; = 'CUTOFF'" name="Cutoff">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
        </labelStyle>
      ...
      <attributeEditorContainer collapsedExpressionEnabled="0" columnCount="1" collapsedExpression="" showLabel="0" groupBox="1" collapsed="0" visibilityExpressionEnabled="1" visibilityExpression="&quot;Type&quot; = 'TABULAR'" name="Tabular">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
        </labelStyle>
      ...
      <attributeEditorContainer collapsedExpressionEnabled="0" columnCount="1" collapsedExpression="" showLabel="0" groupBox="1" collapsed="0" visibilityExpressionEnabled="1" visibilityExpression="&quot;Type&quot; = 'WEIR'" name="Weir">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
        </labelStyle>
    ...
    <attributeEditorField index="14" showLabel="1" name="Annotation">
      <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
        <labelFont bold="0" style="" underline="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0"/>
      </labelStyle>
    </attributeEditorField>
