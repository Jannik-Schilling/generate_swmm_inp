...
<qgis hasScaleBasedVisibilityFlag="0" minScale="100000000" styleCategories="AllStyleCategories" simplifyDrawingHints="1" labelsEnabled="0" symbologyReferenceScale="-1" simplifyMaxScale="1" version="3.30.3-'s-Hertogenbosch" maxScale="0" readOnly="0" simplifyDrawingTol="1" simplifyAlgorithm="0" simplifyLocal="1">
  ...
  <elevation type="IndividualFeatures" zscale="1" extrusion="0" clamping="Terrain" symbology="Line" zoffset="0" binding="Centroid" showMarkerSymbolInSurfacePlots="0" extrusionEnabled="0" respectLayerSymbol="1">
    ...
    <profileLineSymbol>
      <symbol type="line" frame_rate="10" name="" alpha="1" clip_to_extent="1" force_rhr="0" is_animated="0">
        ...
        <layer enabled="1" id="{8f2d7bf6-d48e-45f5-ad59-c929108e5cf6}" class="SimpleLine" locked="0" pass="0">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol type="fill" frame_rate="10" name="" alpha="1" clip_to_extent="1" force_rhr="0" is_animated="0">
        ...
        <layer enabled="1" id="{5365efb2-96a7-4924-b07a-9187aa7ff082}" class="SimpleFill" locked="0" pass="0">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol type="marker" frame_rate="10" name="" alpha="1" clip_to_extent="1" force_rhr="0" is_animated="0">
        ...
        <layer enabled="1" id="{ca7aa365-b53a-46af-ac24-6b3ba69edacc}" class="SimpleMarker" locked="0" pass="0">
          <Option type="Map">
  ...
  <renderer-v2 type="singleSymbol" enableorderby="0" forceraster="0" symbollevels="0" referencescale="-1">
    <symbols>
      <symbol type="line" frame_rate="10" name="0" alpha="1" clip_to_extent="1" force_rhr="0" is_animated="0">
        ...
        <layer enabled="1" id="{820062d2-8b41-46a7-b9b7-43449ef30fd9}" class="MarkerLine" locked="0" pass="0">
          <Option type="Map">
          ...
          <symbol type="marker" frame_rate="10" name="@0@0" alpha="1" clip_to_extent="1" force_rhr="0" is_animated="0">
            ...
            <layer enabled="1" id="{9a04e14d-92ad-4148-a354-8d3f109ea262}" class="SimpleMarker" locked="0" pass="0">
              <Option type="Map">
            ...
            <layer enabled="1" id="{eedb592f-3746-4d5f-bc14-de64cb7ada62}" class="SimpleMarker" locked="0" pass="0">
              <Option type="Map">
                <Option type="QString" name="angle" value="0"/>
                <Option type="QString" name="cap_style" value="square"/>
                <Option type="QString" name="color" value="0,0,0,255"/>
        ...
        <layer enabled="1" id="{78d62ecb-fc91-4fc5-b7f3-b6b35bf46ab8}" class="SimpleLine" locked="0" pass="0">
          <Option type="Map">
            <Option type="QString" name="align_dash_pattern" value="0"/>
            <Option type="QString" name="capstyle" value="square"/>
            <Option type="QString" name="customdash" value="5;2"/>
    ...
    <DiagramCategory scaleDependency="Area" showAxis="1" sizeType="MM" lineSizeType="MM" spacingUnit="MM" lineSizeScale="3x:0,0,0,0,0,0" labelPlacementMethod="XHeight" rotationOffset="270" backgroundColor="#ffffff" backgroundAlpha="255" maxScaleDenominator="1e+08" penWidth="0" minimumSize="0" width="15" sizeScale="3x:0,0,0,0,0,0" scaleBasedVisibility="0" spacing="5" spacingUnitScale="3x:0,0,0,0,0,0" enabled="0" direction="0" barWidth="5" penAlpha="255" diagramOrientation="Up" height="15" penColor="#000000" opacity="1" minScaleDenominator="0">
      ...
      <axisSymbol>
        <symbol type="line" frame_rate="10" name="" alpha="1" clip_to_extent="1" force_rhr="0" is_animated="0">
          ...
          <layer enabled="1" id="{f9ba06aa-de4c-4403-b324-42e1f9cd2205}" class="SimpleLine" locked="0" pass="0">
            <Option type="Map">
              <Option type="QString" name="align_dash_pattern" value="0"/>
              <Option type="QString" name="capstyle" value="square"/>
              <Option type="QString" name="customdash" value="5;2"/>
        ...
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" name="FUNCTIONAL/DEPTH" value="FUNCTIONAL/DEPTH"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="FUNCTIONAL/HEAD" value="FUNCTIONAL/HEAD"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="TABULAR/DEPTH" value="TABULAR/DEPTH"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="TABULAR/HEAD" value="TABULAR/HEAD"/>
              </Option>
            </Option>
          </Option>
        </config>
  ...
  <defaults>
    ...
    <default field="InOffset" applyOnUpdate="0" expression=""/>
    <default field="RateCurve" applyOnUpdate="0" expression=""/>
    <default field="Qcoeff" applyOnUpdate="0" expression=""/>
    <default field="Qexpon" applyOnUpdate="0" expression=""/>
    <default field="FlapGate" applyOnUpdate="0" expression=""/>
    <default field="CurveName" applyOnUpdate="0" expression=""/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" field="InOffset" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint notnull_strength="0" field="RateCurve" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint notnull_strength="0" field="Qcoeff" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint notnull_strength="0" field="Qexpon" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint notnull_strength="1" field="FlapGate" exp_strength="0" constraints="1" unique_strength="0"/>
    <constraint notnull_strength="0" field="CurveName" exp_strength="0" constraints="0" unique_strength="0"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column width="-1" type="field" hidden="0" name="InOffset"/>
      <column width="-1" type="field" hidden="0" name="Qcoeff"/>
      <column width="-1" type="field" hidden="0" name="FlapGate"/>
      <column width="-1" type="field" hidden="0" name="RateCurve"/>
      <column width="-1" type="field" hidden="0" name="Qexpon"/>
      <column width="-1" type="field" hidden="0" name="CurveName"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer visibilityExpressionEnabled="0" visibilityExpression="" name="General" groupBox="0" columnCount="1" collapsed="0" collapsedExpression="" showLabel="1" collapsedExpressionEnabled="0">
      ...
      <attributeEditorField name="InOffset" showLabel="1" index="4">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" underline="0" strikethrough="0" italic="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField name="FlapGate" showLabel="1" index="8">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" underline="0" strikethrough="0" italic="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    </attributeEditorContainer>
    <attributeEditorContainer visibilityExpressionEnabled="0" visibilityExpression="" name="Rating Curve" groupBox="0" columnCount="1" collapsed="0" collapsedExpression="" showLabel="1" collapsedExpressionEnabled="0">
      <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
        <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" underline="0" strikethrough="0" italic="0" style="" bold="0"/>
      </labelStyle>
      <attributeEditorField name="RateCurve" showLabel="1" index="5">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" underline="0" strikethrough="0" italic="0" style="" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorContainer visibilityExpressionEnabled="1" visibilityExpression="&quot;RateCurve&quot; = 'FUNCTIONAL/DEPTH' or &quot;RateCurve&quot; = 'FUNCTIONAL/HEAD' " name="Functional" groupBox="1" columnCount="1" collapsed="0" collapsedExpression="" showLabel="0" collapsedExpressionEnabled="0">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" underline="0" strikethrough="0" italic="0" style="" bold="0"/>
        </labelStyle>
        ...
        <attributeEditorField name="Qexpon" showLabel="1" index="7">
          <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
            <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" underline="0" strikethrough="0" italic="0" style="" bold="0"/>
          </labelStyle>
        </attributeEditorField>
      </attributeEditorContainer>
      <attributeEditorContainer visibilityExpressionEnabled="1" visibilityExpression="&quot;RateCurve&quot; = 'TABULAR/DEPTH' or &quot;RateCurve&quot; = 'TABULAR/HEAD'" name="Tabular" groupBox="1" columnCount="1" collapsed="0" collapsedExpression="" showLabel="0" collapsedExpressionEnabled="0">
        <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
          <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" underline="0" strikethrough="0" italic="0" style="" bold="0"/>
        </labelStyle>
        <attributeEditorField name="CurveName" showLabel="1" index="9">
          <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
            <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" underline="0" strikethrough="0" italic="0" style="" bold="0"/>
          </labelStyle>
        </attributeEditorField>
    ...
    <attributeEditorField name="Annotation" showLabel="1" index="10">
      <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
        <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" underline="0" strikethrough="0" italic="0" style="" bold="0"/>
      </labelStyle>
    </attributeEditorField>
    <attributeEditorAction ActionUUID="{60fa1e62-3b82-46ad-83c4-a765c64b5ac5}" name="{60fa1e62-3b82-46ad-83c4-a765c64b5ac5}" showLabel="1">
      <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
        <labelFont description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" underline="0" strikethrough="0" italic="0" style="" bold="0"/>
      </labelStyle>
  ...
  <reuseLastValue>
    ...
    <field name="CurveName" reuseLastValue="0"/>
    ...
    <field name="Qexpon" reuseLastValue="0"/>
    <field name="RateCurve" reuseLastValue="0"/>
