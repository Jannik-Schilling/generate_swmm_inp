...
<qgis version="3.18.3-Zürich" minScale="100000000" simplifyDrawingHints="1" simplifyMaxScale="1" simplifyDrawingTol="1" simplifyLocal="1" styleCategories="Symbology|Rendering" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyAlgorithm="0">
    ...
    <symbols>
      <symbol force_rhr="0" alpha="1" type="fill" name="0" clip_to_extent="1">
        ...
        <layer pass="0" enabled="1" class="GeometryGenerator" locked="0">
          ...
          <prop v="if ( @map_scale > 10000, NULL, make_line(centroid($geometry),geometry(get_feature('SWMM_junctions', 'Name',&quot;Outlet&quot;))))" k="geometryModifier"/>
          <data_defined_properties>
            <Option type="Map">
              <Option value="" type="QString" name="name"/>
              <Option name="properties"/>
